...
def give_song(game_id: str, video_clip, duration: int, filename: str) -> str:
    """
    ...
    os.makedirs(os.path.join(paths.concatenated_with_music, game_id), exist_ok=True)
    to_return_path = os.path.join(paths.concatenated_with_music, game_id, filename)
