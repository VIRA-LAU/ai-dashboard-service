...
from utils.general import labels_to_class_weights, labels_to_image_weights, init_seeds, \
    fitness, strip_optimizer, check_dataset, check_img_size, print_mutation, one_cycle, colorstr
...
def train_detection(hyp, opt, device, tb_writer=None):
...
def train_detection_evolve(hyp, opt, device):
    ...
    for _ in range(300):  # generations to evolve
        ...
        # Train mutation
        results = train_detection(hyp.copy(), opt, device)
