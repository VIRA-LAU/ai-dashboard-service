...
from yolo_tracking.boxmot.appearance import export_formats
from yolo_tracking.boxmot.appearance.backbones import build_model, get_nr_classes
from yolo_tracking.boxmot.appearance.reid_model_factory import (get_model_name,
                                                  load_pretrained_weights)
from yolo_tracking.boxmot.utils import WEIGHTS
...
def run():
    ...
    parser.add_argument(
        "--weights",
        type=Path,
        default="weights/osnet_x0_25_imagenet.pth",
