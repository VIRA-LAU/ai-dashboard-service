...
def detect_all(game_id: str = ''):
    ...
    with torch.no_grad():
        ...
        segmentation_weights = 'weights/yolov8n-seg.pt'
        reid_model = Path("weights/osnet_x0_25_imagenet.torchscript")
        ...
        # Segmentation
        instance_segmentation(weights=segmentation_weights, 
                            reid_model=reid_model,
                            source=videoPath,
...
if __name__ == '__main__':
    extract_key_frames(dataset_folder='PhoneFive', video_max_len = 3500, fps=5)
